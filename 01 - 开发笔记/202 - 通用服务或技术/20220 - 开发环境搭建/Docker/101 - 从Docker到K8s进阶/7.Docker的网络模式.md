...
​​![bridge network](docker-netework-bridge.jpeg)
...
​​![network host](docker-network-host.jpeg)
...
Container模式示意图：
![network container](docker-network-container.jpeg)
​​
演示：
```shell
...
None模式示意图:
![network none](docker-network-none.jpeg)
​​
演示：
```shell
