...
![promtheus opeator](prometheus-operator.png)
...
![promtheus operator targets](promethues-operator-targets.png)
...
![promethus kube-scheduler error](promethues-operator-kube-scheduler-error.png)
...
![promethues-operator-kube-scheduler](promethues-operator-kube-scheduler.png)
...
![promethues-operator-grafana](promethues-operator-grafana.png)
